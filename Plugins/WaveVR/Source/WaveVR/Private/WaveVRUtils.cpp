...
bool NativeModelParameter::mSpawnControllerFlag = false;
WVR_DeviceType NativeModelParameter::mDeviceType = WVR_DeviceType::WVR_DeviceType_Invalid;
bool NativeModelParameter::mAlwaysShow = false;
bool NativeModelParameter::HideWhenIdle = true;
...
void NativeModelParameter::SetSpawnFlag(bool flag)
{
	mSpawnControllerFlag = flag;
}

bool NativeModelParameter::GetSpawnFlag()
{
	return mSpawnControllerFlag;
}

void NativeModelParameter::SetSpawnDeviceType(WVR_DeviceType deviceType)
{
	mDeviceType = deviceType;
}

WVR_DeviceType NativeModelParameter::GetSpawnDeviceType()
{
	return mDeviceType;
}

void NativeModelParameter::SetAlwaysShow(bool show)
{
	mAlwaysShow = show;
}

bool NativeModelParameter::GetAlwaysShow()
{
	return mAlwaysShow;
}
