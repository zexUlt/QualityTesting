...
bool FWaveVRPlatformWindows::IsRenderFoveationEnabled() {
	LOG_FUNC();
	FUNC_PTR(IsRenderFoveationEnabled);
	FUNC_RUN();
	FUNC_CHECK();
	return false; //failure
}

WVR_Result FWaveVRPlatformWindows::RenderFoveationMode(WVR_FoveationMode mode) {
	LOG_FUNC();
	FUNC_PTR(RenderFoveationMode);
	FUNC_RUN_1(mode);
	FUNC_CHECK();
	return WVR_Result::WVR_Error_FeatureNotSupport;
}

WVR_Result FWaveVRPlatformWindows::SetFoveationConfig(const WVR_Eye eye, const WVR_RenderFoveationParams_t *foveatedParam) {
	LOG_FUNC();
	FUNC_PTR(SetFoveationConfig);
	FUNC_RUN_2(eye, foveatedParam);
	FUNC_CHECK();
	return WVR_Result::WVR_Error_FeatureNotSupport;
}

WVR_Result FWaveVRPlatformWindows::GetFoveationDefaultConfig(const WVR_Eye eye, WVR_RenderFoveationParams_t *foveatedParam) {
	LOG_FUNC();
	FUNC_PTR(GetFoveationDefaultConfig);
	FUNC_RUN_2(eye, foveatedParam);
	FUNC_CHECK();
	return WVR_Result::WVR_Error_FeatureNotSupport;
}
