...
UARPin* FWaveVRHMD::FindARPinByComponent(const USceneComponent* Component) const
{
	LOG_FUNC();
...
bool FWaveVRHMD::OnPinComponentToARPin(USceneComponent* ComponentToPin, UARPin* Pin)
{
	LOG_FUNC();
	// TODO: PinComponentToARPin
	return false;
}
