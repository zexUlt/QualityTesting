...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "WaveVR|Permission", meta = (
		ToolTip = "Return true if this permission should be granted.", DeprecatedFunction, DeprecationMessage = "Use isPermissionGranted instead, the return value of shouldGrantPermission is the negative return value of isPermissionGranted."))
	...
	UFUNCTION(BlueprintCallable, Category = "WaveVR|Permission", meta = (
		ToolTip = "Show a dialog to let user choice grant or deny for Usb permissions you want to request.", DeprecatedFunction))
